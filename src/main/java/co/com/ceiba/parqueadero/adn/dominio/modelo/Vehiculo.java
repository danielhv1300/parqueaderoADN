...
public class Vehiculo {
	...
	public static final String MENSAJE_RESTRICCION_POR_PLACA = "Los vehiculos que inician con la letra A en su placa, solo ingresan los dias domingos y lunes";
	...
	public Vehiculo(Long id, String placa, String tipoVehiculo, int cilindraje, Calendar fechaIngreso, Calendar fechaSalida, double valor) {
		...
		if(tipoVehiculo.equalsIgnoreCase(Constantes.TIPO_VEHICULO_MOTO)) {
			ValidadorVehiculo.validarCilindrajeObligatorio(cilindraje, MENSAJE_CAMPO_CILINDRAJE_OBLIGATORIO);
		}
