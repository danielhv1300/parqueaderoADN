...
public class Vehiculo {
	...
	public static final String MENSAJE_RESTRICCION_POR_PLACA = "Por politicas del parqueadero el vehiculo no puede ingresar el dia de hoy debido a que su placa inicia por \"A\", solo pude ingresar los días lunes y domingos";
